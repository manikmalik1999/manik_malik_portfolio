    ...
    <LampContainer>
      <div className="flex flex-col items-center justify-center">
        ...
        <p className="text-center md:tracking-wider mt-4 mb-4 text-sm md:text-lg lg:text-2xl">
          Hi, I&apos;m Manik, a digital craftsman from Germany. I blend AI, cloud-native innovation, and a dash of caffeine to convert raw ideas into intelligent, scalable systems. Say goodbye to buggy code and hello to automation that truly works!
        </p>
        <a href="#projects">
          <MagicButton
            title="Show my work"
