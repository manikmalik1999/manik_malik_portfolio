...
export const gridItems = [
  {
    id: 1,
    title: 'From AI Research to Scalable Systems – I Build What’s Next',
    description: '',
  ...
  {
    id: 2,
    title: "Debugging by Day, Architecting by Night – The Full-Stack Life",
    description: '',
  ...
  },
  {
    id: 3,
    title: 'Skills',
    description: 'Mastering AI, Cloud, and Code',
    className: 'lg:col-span-2 md:col-span-3 md:row-span-2',
    imgClassName: '',
  ...
  {
    id: 4,
    title: 'Turning Data into Decisions, Code into Impact',
    description: '',
  ...
  {
    id: 5,
    title: 'Crafting AI-Powered Solutions for Tomorrow’s Challenges',
...
export const projects = [
  {
    ...
    des: 'A social media app for VIT students, alumni, and faculty with authentication, posts, likes, comments, and inbuilt chat.',
    img: '/image2.svg',
  ...
  },
  {
    ...
    des: 'An Android app displaying global Covid-19 stats and vaccination availability in India via government APIs.',
    img: '/image3.svg',
  ...
  },
  {
    ...
    des: 'A modular Android app with advanced inventory forecasting and tailored recommendations using data-driven insights.',
    img: '/image4.svg',
  ...
  },
  {
    ...
    des: 'A website with syntax highlighting for HTML, CSS, and JS, plus a live preview.',
    img: '/image6.svg',
